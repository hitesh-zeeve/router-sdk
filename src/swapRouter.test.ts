import { BigintIsh, CurrencyAmount, Ether, Percent, Token, TradeType, WETH9 } from '@hitesh.sharma_/sdk-core'
import { Pair, Route as V2Route, Trade as V2Trade } from '@hitesh.sharma_/v2-sdk'
import {
  encodeSqrtRatioX96,
  FeeAmount,
  nearestUsableTick,
